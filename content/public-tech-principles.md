---
title: Public Technology Principles
tags:
  - public-technology
  - policy
  - governance
...
1. Californians should have the opportunity to provide official public comment on government business virtually, at a time and place of their convenience, and upvote other comments.
...
2. Every state agency and local government in California should by default make their public data open and machine readable unless there is a compelling reason otherwise. That should include the dollars spent on legacy information technology systems and data detailing all public procurement.
...
4. This effort to modernize California government should focus on a future its people deserve and have the courage to consolidate obsolete institutions that frustrate progress (for example California's [two duplicative state water agencies](https://lhc.ca.gov/sites/lhc.ca.gov/files/Reports/201/Report201.pdf)).

## Implementation Strategy

In implementing these principles, California's public sector should strive to embody the "pioneering spirit" that has made this state great. The following strategies aim to provide a creative, comprehensive approach to improve how government operates in California and beyond:
...
2. The California Department of Technology should open a new **digital office in Oakland** to make modern design and information technology practices the new normal in California government. This strategy was more fully articulated in a [letter from Code for America Founder Jennifer Pahlka to the next Governor](https://medium.com/@pahlkadot/dear-governor-elect-72e2f5e3bfdb).
3. California should formalize a nonprofit **Applied Research arm** of the California Government Operations agency to serve as an independent utility stewarding public data across local municipalities. That effort should build from leading global examples like the UK's Administrative Data Research Network and the New Zealand Integrated Data Services.
4. All California state and local governments should **open their doors to new talent** with skills in agile software development, data science and other important digital skills, including support for training public servants on these new tools.
5. From start to finish, new government digital service and data science projects should strive to **include the community** in planning, design, implementation and ongoing maintenance wherever possible.
6. Regional and local governments should be incentivized to **collaborate and jointly procure** technology and services. By aggregating demand and developing standards to meet common needs, California governments can save money while deploying better public technology.
7. California should have the courage to **lead boldly into the future**. To avoid being trapped by past accidents of history, California should undertake a comprehensive review examining how to modernize obsolete and consolidate duplicative government agencies.

---

*These principles were developed through the California Public Technology Roundtable — a coalition of [[data-collaboratives|Code for America brigades]], journalists, local activists, reform groups, and public officials. See also: [[reform-and-renewal|Reform and Renewal]] for the intellectual framework behind these strategies.*
